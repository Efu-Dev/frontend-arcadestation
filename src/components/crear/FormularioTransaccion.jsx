                ...
                <img src={img4} class="logo" onClick={() => navigate('/home')} style={{cursor:'pointer'}} />  
                    ...
                    <form class="div-gerente rectangulo_transaccion" onSubmit={(e) => checkCreacion(e)}>
                        ...
                        <div class="div-gerente" id="Tarjeta">
                            Tarjeta:
                            <input placeholder='Ejemplo: 1234567890123' type="text" class="tarjeta" name="tarjeta" onInput={e => {e.preventDefault(); e.target.setCustomValidity('')}} onInvalid={e => e.target.setCustomValidity('Este campo debe estar lleno y seguir un formato de únicamente dígitos numéricos. Ejemplo: 123456789.')} maxLength={13} pattern='\d+' value={tarjeta} onChange={(e) => onChangeTarjeta(e.target.value.replace(/^\s+/, ""))} required />
                        </div>

                        {
                            editable ? (
                                ...
                                <div class="div-gerente" id="Referencia">
                                    Referencia:
                                    <input placeholder='Ejemplo: 125540' maxLength={45} type="text" class="monto" name="referencia" value={referencia} onChange={(e) => setReferencia(e.target.value.replace(/\s+/, ""))} pattern="\d+" required  />
                                </div>
                                <div class="div-gerente" id="Tipo">
                                    Tipo de Pago:
